...
def parse_input(user_input: str):
    ...
    try:
        ...
        raise InvalidInputError(
            ...
            + str([x.name for x in game_elements.Pawns])
        )
...
def init_game():
    ...
    players = [
        game_elements.Player(color=game_elements.Colors.BLUE),
        game_elements.Player(color=game_elements.Colors.RED),
    ]
    ...
    while 1:
        try:
            ...
            if player.color == game_elements.Colors.BLUE:
                ...
                move = minmax.get_best_move(board, player, other_player)
                if move is None:
...
def botvsbot():
    ...
    board.play(1, 1, game_elements.Pawns.A, player.color)
    player.remove(game_elements.Pawns.A)
    board.print()
    player = next(player_cycle)
...
def rules():
    ...
    board = game_elements.Board(
        board=[
            [
                (game_elements.Pawns.B, game_elements.Colors.RED),
                (game_elements.Pawns.A, game_elements.Colors.RED),
                (game_elements.Pawns.B, game_elements.Colors.RED),
                None,
            ],
            [None, None, None, None],
            [
                None,
                None,
                (game_elements.Pawns.A, game_elements.Colors.BLUE),
                (game_elements.Pawns.B, game_elements.Colors.BLUE),
            ],
