...
def test_best_move_last():
    board = Board(board=[
            [(Pawns.A, Colors.BLUE), (Pawns.B, Colors.BLUE), (Pawns.C, Colors.BLUE), None],
    ...
    blue_player = Player(
        color = Colors.BLUE,
        pawns = [Pawns.A, Pawns.B, Pawns.C, Pawns.D,]
    )
    red_player = Player(
        color = Colors.RED,
        pawns = [Pawns.A, Pawns.B, Pawns.C, Pawns.D,]
...
def test_best_move_none():
    board = Board(board=[
            [(Pawns.A, Colors.BLUE), (Pawns.B, Colors.BLUE), (Pawns.C, Colors.BLUE), (Pawns.C, Colors.BLUE)],
            [(Pawns.C, Colors.RED), (Pawns.B, Colors.BLUE), (Pawns.B, Colors.BLUE), (Pawns.B, Colors.BLUE)],
            [(Pawns.B, Colors.BLUE), (Pawns.D, Colors.RED), (Pawns.B, Colors.BLUE), (Pawns.B, Colors.BLUE)],
            [(Pawns.B, Colors.BLUE), (Pawns.B, Colors.BLUE), (Pawns.B, Colors.BLUE), (Pawns.B, Colors.BLUE)]
        ])
    blue_player = Player(
        color = Colors.BLUE,
        pawns = [Pawns.A, Pawns.B, Pawns.C, Pawns.D,]
...
def test_best_move_1():
    board = Board(board=[
            [(Pawns.C, Colors.RED), None, (Pawns.C, Colors.RED), (Pawns.D, Colors.BLUE)],
    ...
    blue_player = Player(
        color = Colors.BLUE,
        pawns = [Pawns.B, Pawns.C, Pawns.C, Pawns.D,]
    )
    red_player = Player(
        color = Colors.RED,
        pawns = [Pawns.A, Pawns.A, Pawns.B, Pawns.D, Pawns.D,]
    )
    best_move = minmax.get_best_move(board, red_player, blue_player)
